...
#> Chain 1: 
#> Chain 1:  Elapsed Time: 2.191 seconds (Warm-up)
...
#> Chain 2: 
#> Chain 2:  Elapsed Time: 2.209 seconds (Warm-up)
#> Chain 2:                1.52 seconds (Sampling)
#> Chain 2:                3.729 seconds (Total)
#> Chain 2: 
#> 
...
#> Chain 4: 
#> Chain 4:  Elapsed Time: 2.124 seconds (Warm-up)
#> Chain 4:                1.698 seconds (Sampling)
#> Chain 4:                3.822 seconds (Total)
#> Chain 4: 
...
#> Chain 1: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 2.724 seconds (Warm-up)
#> Chain 1:                2.655 seconds (Sampling)
#> Chain 1:                5.379 seconds (Total)
#> Chain 1: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 2).
#> Chain 2: 
...
#> Chain 2: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 2: 
#> Chain 2:  Elapsed Time: 2.835 seconds (Warm-up)
#> Chain 2:                2.461 seconds (Sampling)
#> Chain 2:                5.296 seconds (Total)
#> Chain 2: 
summary(fit2)
#>  Family: sratio 
#>   Links: mu = logit 
...
#> Chain 2: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 2: 
#> Chain 2:  Elapsed Time: 1.163 seconds (Warm-up)
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 12.799 seconds (Warm-up)
#> Chain 4:                13.099 seconds (Sampling)
#> Chain 4:                25.898 seconds (Total)
#> Chain 4: 
...
#> Chain 1: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 2.232 seconds (Warm-up)
#> Chain 1:                1.305 seconds (Sampling)
...
#> Chain 2: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 2: 
#> Chain 2:  Elapsed Time: 2.596 seconds (Warm-up)
#> Chain 2:                1.351 seconds (Sampling)
#> Chain 2:                3.947 seconds (Total)
#> Chain 2: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 3).
#> Chain 3: Rejecting initial value:
...
#> Chain 3: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 3: 
#> Chain 3:  Elapsed Time: 2.623 seconds (Warm-up)
#> Chain 3:                1.388 seconds (Sampling)
#> Chain 3:                4.011 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: Rejecting initial value:
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 2.55 seconds (Warm-up)
#> Chain 4:                1.217 seconds (Sampling)
#> Chain 4:                3.767 seconds (Total)
#> Chain 4: 
summary(fit5)
#>  Family: gaussian 
#>   Links: mu = identity 
