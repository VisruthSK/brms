...
#> Chain 1: 
#> Chain 1: Gradient evaluation took 0.051239 seconds
#> Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 512.39 seconds.
...
#> Chain 1: 
#> Chain 1:  Elapsed Time: 1.778 seconds (Warm-up)
...
#> Chain 2:                1.688 seconds (Sampling)
...
#> Chain 3: 
#> Chain 3:  Elapsed Time: 1.785 seconds (Warm-up)
