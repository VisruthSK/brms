...
#> Chain 1: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 1.745 seconds (Warm-up)
#> Chain 1:                0.783 seconds (Sampling)
#> Chain 1:                2.528 seconds (Total)
#> Chain 1: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 2).
#> Chain 2: 
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 1.636 seconds (Warm-up)
#> Chain 4:                0.796 seconds (Sampling)
#> Chain 4:                2.432 seconds (Total)
#> Chain 4: 
